...
description: Comprehensive financial data scraping and analytics for SEC filings, earnings, crypto on-chain data, news sentiment, and macro indicators. Use when users need to: (1) Retrieve SEC EDGAR filings (10-K, 10-Q, 8-K), (2) Track upcoming earnings and historical performance, (3) Monitor crypto on-chain metrics and whale alerts, (4) Analyze financial news sentiment, (5) Access macroeconomic indicators (Fed rates, CPI, unemployment), or any financial data research and analysis tasks.
---

# Finance Data Intelligence

Financial data scraping and analytics skill for OpenClaw.
...
|---------|---------|-----------|
| Alpha Vantage | Stock prices, earnings | 25 calls/day |
...
- `scripts/market_data.py` - Stock prices and earnings
- `scripts/crypto_onchain.py` - Blockchain data via Dune
